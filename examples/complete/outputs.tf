output "this_emr_cluster_id" {
  ...
  value       = module.emr-hadoop.this_emr_cluster_id
}

output "this_emr_cluster_name" {
  description = "The name of this new created emr cluster."
  value       = module.emr-hadoop.this_emr_cluster_name
}
